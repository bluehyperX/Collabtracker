...
const Repositories = () => 
{
    ...
    // most_active_repo_rows.forEach(element => {
    //     element.last_commit = convertToIST(element.last_commit);
    // });

    // least_active_repo_rows.forEach(element => {
    //     element.last_commit = convertToIST(element.last_commit);
    // });
    ...
    <div>
        ...
        <br/>
        {
            ...
            (
                ...
                // max_changes = {data.max_changes[repo]}
                // avg_changes = {data.avg_changes[repo]}
                />
            ))
        }   
        </div>       
